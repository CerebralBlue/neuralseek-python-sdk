...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/neuralseek/sdk). Delete this section before > publishing to a package manager.
...
* [identify](docs/sdks/identifylanguage/README.md#identify) - Identify the source language
...
* [post](docs/sdks/train/README.md#post) - Submit KnowledgeBase Training
